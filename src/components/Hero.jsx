  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi, I'm <span className="text-[#9153ff]">Rayyan.</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Sophomore at NIT Silchar. <br className="sm:block hidden" />I develop websites for fun and also love competitive programming.
          </p>
        </div>
      </div>
